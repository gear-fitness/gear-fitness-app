...
public class AppUserController {
  ...
  /** GET /api/users/me Get current authenticated user's profile (basic info) */
  @GetMapping("/me")
  ...
  /**
   * GET /api/users/me/profile Get current authenticated user's enhanced profile with workout stats
   * and social metrics
   */
  ...
  /**
   * GET /api/users/{username} Get enhanced user profile by username Optionally include viewing
   * user's perspective for follow status
   */
  @GetMapping("/{username}")
  public ResponseEntity<?> getUserByUsername(
    ...
    try {
      ...
      UserProfileDTO profile =
          userService.getEnhancedUserProfileByUsername(username, viewingUserId);
  ...
  /** PATCH /api/users/me/privacy Toggle user privacy setting */
  ...
  public ResponseEntity<?> updatePrivacySetting(
    ...
    try {
      ...
      UpdateUserProfileRequest privacyRequest =
          UpdateUserProfileRequest.builder().isPrivate(request.getIsPrivate()).build();
