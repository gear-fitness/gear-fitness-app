...
-- Insert Exercises (no body_part column anymore)
INSERT INTO exercise (exercise_id, name, description)
VALUES
    ('650e8400-e29b-41d4-a716-446655440001', 'Bench Press', 'Compound push exercise targeting chest, shoulders, and triceps.'),
    ('650e8400-e29b-41d4-a716-446655440002', 'Squat', 'Compound lower body exercise targeting quads, glutes, and hamstrings.'),
    ('650e8400-e29b-41d4-a716-446655440003', 'Deadlift', 'Full body compound exercise primarily targeting back and legs.'),
    ('650e8400-e29b-41d4-a716-446655440004', 'Overhead Press', 'Vertical pressing movement for shoulders and triceps.'),
    ('650e8400-e29b-41d4-a716-446655440005', 'Barbell Row', 'Horizontal pulling exercise for back thickness.'),
    ('650e8400-e29b-41d4-a716-446655440006', 'Pull Up', 'Vertical pulling exercise for back width and biceps.'),
    ('650e8400-e29b-41d4-a716-446655440007', 'Dumbbell Curl', 'Isolation exercise for biceps.'),
    ('650e8400-e29b-41d4-a716-446655440008', 'Tricep Dips', 'Compound pushing exercise for triceps.'),
    ('650e8400-e29b-41d4-a716-446655440009', 'Leg Press', 'Machine exercise for quads and glutes.'),
    ('650e8400-e29b-41d4-a716-446655440010', 'Lat Pulldown', 'Machine exercise for lat development.'),
    ('650e8400-e29b-41d4-a716-446655440011', 'Leg Curl', 'Isolation exercise for hamstrings.'),
    ('650e8400-e29b-41d4-a716-446655440012', 'Calf Raise', 'Isolation exercise for calves.'),
...
VALUES
    ...
    ('650e8400-e29b-41d4-a716-446655440007', 'FOREARMS', 'SECONDARY'),

    -- Tricep Dips: triceps primary, chest/shoulders secondary
    ('650e8400-e29b-41d4-a716-446655440008', 'TRICEPS', 'PRIMARY'),
    ('650e8400-e29b-41d4-a716-446655440008', 'CHEST', 'SECONDARY'),
    ('650e8400-e29b-41d4-a716-446655440008', 'SHOULDERS', 'SECONDARY'),
...
-- Insert Workout Sets for Bryant's Dips (bodyweight)
INSERT INTO workout_set (workout_set_id, workout_exercise_id, set_number, reps, weight_lbs, is_pr)
VALUES
